...
# rename columns
df = df.rename({"TP_FAIXA_ETARIA": "faixa etária", "TP_SEXO": "sexo", "TP_COR_RACA": "cor-raça",
...
df['faixa etária'] = df['faixa etária'].map(
...
df = df.groupby(
    ['faixa etária', 'sexo', 'cor-raça', 'situação ens.', 'tipo escola', 'presença', 'residentes']).size().reset_index()
